...
#define ENC28J60_CONTROL_SO		5
#define ENC28J60_CONTROL_SI		6	
#define ENC28J60_CONTROL_SCK	7
// set CS to 0 = active
...
void enc28j60Init(uint8_t* macaddr)
{
	...
	// do bank 1 stuff, packet filter:
        ...
        // This is hex 303F->EPMM0=0x3f,EPMM1=0x3
		// for broadcast |ERXFCON_PMEN|ERXFCON_BCEN
...
uint16_t enc28j60PacketReceive(uint16_t maxlen, uint8_t* packet)
{
	...
	enc28j60Write(ERXRDPTH, (gNextPacketPtr)>>8);
		...
		{
			enc28j60Write(ERXRDPTL, (gNextPacketPtr-RXSTOP_INIT+RXSTART_INIT)&0xFF);
			enc28j60Write(ERXRDPTL, (gNextPacketPtr-RXSTOP_INIT+RXSTART_INIT)>>8);
        } else {
